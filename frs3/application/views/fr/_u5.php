...
<div class="portlet light">
    ...
    <div class="portlet-body form">
    	...
    	<div class="note note-bordered note-danger" style="text-align:left">
            <strong>Maaf tidak ada produk smartphone dengan : </strong><br>
			<?php if((isset($result['contra_pref']['price']['start']) && !empty($result['contra_pref']['price']['start'])) && (isset($result['contra_pref']['price']['end']))) { ?>
				- budget antara <? print_r($result['contra_pref']['price']['start']); }?>
			<?php if(isset($result['contra_pref']['price']) && !empty($result['contra_pref']['price'])) {?> 
				sampai <? print_r($result['contra_pref']['price']['end']); ?> <br> <?}?>
			<?php if(isset($result['contra_pref']['brand']) && !empty($result['contra_pref']['brand'])) {?>
				- merk : <?  echo implode(' atau ',$result['contra_pref']['brand']);  ?> <br> <?}?> 
			<?php if(isset($result['contra_pref']['os']) && !empty($result['contra_pref']['os'])) { ?>
				- sistem operasi :  <? echo implode(' atau ',$result['contra_pref']['os']);
				?> <br> <?}?>
			<?php if(isset($result['contra_pref']['type']) && !empty($result['contra_pref']['type'])) {?>
				- jenis : <?  echo implode(' atau ',$result['contra_pref']['type']);
				?> <br> <?}?>
        </div>
