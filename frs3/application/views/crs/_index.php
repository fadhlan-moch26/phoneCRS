                    ...
                    <div class="col-md-7">
                       	<div class="radio-list" style="text-align:left">
                        	<label class="radio-inline">
                                <input type="radio" name="inp[u_kategori]" value="3" checked="checked"> 
                                Familiar
                            </label>
                        	<label class="radio-inline">
                                <input type="radio" name="inp[u_kategori]" value="2"> 
                                Cukup Familiar
                            </label>
                        	<label class="radio-inline">
                                <input type="radio" name="inp[u_kategori]" value="1"> 
                                Kurang Familiar
                            </label>
                        	<label class="radio-inline">
                                <input type="radio" name="inp[u_kategori]" value="0"> 
                                Tidak Familiar
                            </label>
                    	</div>
                    </div>
